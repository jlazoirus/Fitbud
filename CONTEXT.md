...
- Catalogo Supabase: ingredientes, platos, recetas, dietas y vista `dish_macros`. `supabase/seed.sql` carga el catalogo base expandido: 162 ingredientes, 145 platos y 522 lineas de receta tras REQ-140.
