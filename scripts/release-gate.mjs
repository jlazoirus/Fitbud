...
console.log("\n[ Validadores de dominio ]");
run("test-nutrition-pure.mjs", "node scripts/test-nutrition-pure.mjs");
...
run("validate-macro-target-wiring.mjs", "node scripts/validate-macro-target-wiring.mjs");
...
run("test-checkin-goal-mapping.mjs", "node scripts/test-checkin-goal-mapping.mjs");
run("validate-meal-reorder-skip.mjs", "node scripts/validate-meal-reorder-skip.mjs");
...
run("validate-onboarding-first-week.mjs", "node scripts/validate-onboarding-first-week.mjs");
...
run("validate-e2e-training-fixture.mjs", "node scripts/validate-e2e-training-fixture.mjs");
...
run("test-webhook-renewal.mjs", "node scripts/test-webhook-renewal.mjs");
